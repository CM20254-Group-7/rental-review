...
const PrivacyPolicyPage: NextPage = () => (
  <main className='flex flex-1 flex-col place-items-center justify-center py-10 md:py-16'>
    ...
    <div className='w-3/4'>
      ...
      <br />
      <p>
        These Terms of Service (&quot;Terms&quot;) govern your use of the Rental
        Review website and mobile application (collectively, the
      ...
      <p className='ml-10'>
        ...
        Platform. When registering for an account, you agree to provide
      ...
      <li className='ml-10 w-fit'>
        You agree to use the Platform for lawful purposes only and to comply
        with all applicable laws and regulations.
      </li>
      <li className='ml-10 w-fit'>
        You may not engage in any conduct that violates the rights of others,
        including but not limited to infringing intellectual property rights,
        harassing or defaming others, or distributing spam or malware.
      </li>
      ...
      <li className='ml-10 w-fit'>
        When submitting reviews, ratings and images on the Platform, you agree
        to provide relevant, appropriate, honest and accurate feedback or images
        based on your personal experiences.
      </li>
      <li className='ml-10 w-fit'>
        You may not submit false or misleading reviews, manipulate ratings, or
        engage in any fraudulent activity related to reviews.
      </li>
      <li className='ml-10 w-fit'>
        We reserve the right to remove reviews that violate these Terms or our
        review guidelines with our moderation system.
      </li>
      ...
      <p className='ml-10'>
        ...
        graphics, logos, and software, are protected by copyright, trademark,
        and other intellectual property laws. You may not copy, modify,
        distribute, or reproduce any part of the Platform without our prior
        written consent.
      </p>
      ...
      <p className='ml-10'>
        ...
        content or practices of any third-party sites and encourage you to
      ...
      <p className='ml-10'>
        ...
        Platform will always be secure, error-free, or uninterrupted.
      </p>
      ...
      <p className='ml-10'>
        ...
        the State of the United Kingdom, without regard to its conflict of law
        principles.
      </p>
