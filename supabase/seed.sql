...
-- | user.4@example.com  | User.4.Password  | property-page-tests | Have a review on 1 Test Road                              |
-- | user.5@example.com  | User.5.Password  | property-page-tests | Have reviews on 1 & 2 Test Road                           |
-- | user.6@example.com  | User.6.Password  | property-page-tests | Have a review on 1 Test Road (landlord changed)           |
