...
CREATE UNIQUE INDEX reviewer_public_profiles_pkey ON public.reviewer_public_profiles USING btree (id);
...
CREATE UNIQUE INDEX user_public_profiles_pkey ON public.user_profiles USING btree (id);
...
alter table "public"."landlord_private_profiles" add constraint "landlord_private_profiles_id_fkey" FOREIGN KEY (user_id) REFERENCES user_profiles(id) not valid;
...
alter table "public"."reviewer_private_profiles" add constraint "reviewer_private_profiles_user_id_fkey" FOREIGN KEY (user_id) REFERENCES user_profiles(id) not valid;
...
alter table "public"."reviewer_public_profiles" add constraint "reviewer_public_profiles_id_fkey" FOREIGN KEY (id) REFERENCES reviewer_private_profiles(reviewer_id) not valid;
...
alter table "public"."user_profiles" add constraint "user_public_profiles_id_fkey" FOREIGN KEY (id) REFERENCES auth.users(id) not valid;
